...
The mean of the original data is 'rOriginalmean', Original the standard deviation is 'r OriginalSD'  
...
This graph has 3 different peaks, all of which are at different heights
